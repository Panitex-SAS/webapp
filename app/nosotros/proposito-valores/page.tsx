    ...
    <main className="min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="w-[80%] p-8">
          {/* Header */}
          <div className="mb-12">
            <h1 className="text-4xl font-bold mb-6">Nuestro Propósito y Valores</h1>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="border-l-4 border-red-600 pl-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Ser confiables, siempre</h2>
              <p className="text-xl italic text-gray-500 mb-6">Coherencia, cumplimiento y responsabilidad</p>
            ...
            {/* Section 2 */}
            <section className="border-l-4 border-red-600 pl-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Servir donde más se necesita</h2>
              <p className="text-xl italic text-gray-500 mb-6">La infraestructura como responsabilidad social</p>
              <div className="text-lg text-gray-600 space-y-4 leading-relaxed">
                <p>
            ...
            {/* Section 3 */}
            <section className="border-l-4 border-red-600 pl-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Ejecutar con excelencia</h2>
              <p className="text-xl italic text-gray-500 mb-6">Hacer las cosas bien, incluso bajo presión</p>
              <div className="text-lg text-gray-600 space-y-4 leading-relaxed">
                <p>
            ...
            {/* Section 4 */}
            <section className="border-l-4 border-red-600 pl-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Actuar con ética y transparencia</h2>
              <p className="text-xl italic text-gray-500 mb-6">Integridad sin atajos</p>
              <div className="text-lg text-gray-600 space-y-4 leading-relaxed">
                <p>
